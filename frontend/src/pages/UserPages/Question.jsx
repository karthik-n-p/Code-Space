...
function QuestionPage() {
    ...
    function handleSubmitCode() {
        ...
        axios.post('http://localhost:3000/submit-code', {
          code: code,
          languageId: getLanguageId(language), // Replace with the appropriate language ID
        })
          .then(response => {
        ...
        <HStack display={"flex"}  ml="90px" mb="20px">
            ...
            { Isthereiscode?<Box > 
             ...
             <Box bg="#F8F8F8"  w="650px" margin="10px" display={loading?'none':'block'}  alignItems={"center"} p="10px">
                ...
                <Box bg="#24262C" w="675px" my="10px" p="10px" borderLeftRadius={7} borderWidth={2}>
                <Text align={"left"} fontSize={16} >{loading?'Submission On Queue':output}</Text>
                </Box>
                </Box>:
