...
const CreateQuestionForm = () => {
    ...
    return (
      ...
      {/* Buttons */}
      <Link to="/admincomp"><Button bg="btng" color="txtw" pos={'absolute'} left="370px" top="1180px">
        Save
      </Button></Link>
      <Link to="/admincomp"><Button bg="btng" color="txtw" pos={'absolute'} left="470px" top="1180px">
        Cancel
      </Button></Link>
