        ...
        <Box>
           ...
           <HStack alignItems="top" w="1060px"  height="700px" ml={280} mt="35px" spacing="60px">
                ...
                <Box  h="120px" w="700px" mt="10px" borderRadius={10} borderWidth={2} >
                    ...
                    <Link to="/compdesc1"><Text color={"#2EC866"}  pl="15px" fontSize={22} w="500px">Test Mirror</Text></Link>
                        <div w="195px">
                        ...
                        <Link to="/question"> <Text color="white" fontWeight={"bold"} paddingTop={1}>Solve Question</Text></Link>
                        </Box>
                ...
                <Box  h="120px" w="700px" mt="10px" borderRadius={10} borderWidth={2} >
                    <HStack w="695px" paddingTop="8px">
                    <Link to="/compdesc1"><Text color={"#2EC866"}  pl="15px" fontSize={22} w="500px">Second Mirror</Text></Link>
                        <div w="195px">
                            <HStack spacing={5} align={"center"} pl={10}>
                            <FaEnvelope color="#808191"/><FaMedal color="#808191"/><FaList color="#808191"/>
                            </HStack>
                ...
                <div>
                <HStack w="450px"><Text fontWeight={"semibold"} fontSize={20} color={"white"}  w="360px">Remaining Time</Text>
                <Text fontWeight={"semibold"} fontSize={20} color={"#2EC866"}  w="360px">00:10:20</Text>
                </HStack>
                <Text fontWeight={"semibold"} fontSize={20} color={"white"}  w="360px" mt="50px">Current Rank : N/A</Text>
